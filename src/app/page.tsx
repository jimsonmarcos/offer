...
export default function Home() {
  return (
    <div className="flex flex-1 justify-center min-h-screen bg-[#2B2D42] relative overflow-hidden">
      ...
      <div
        className="h-[618px] w-[1200px] bg-no-repeat flex justify-end self-center relative z-20"
        style={{ backgroundImage: "url('/image.png')" }}
      >
        <div className="w-[995px] h-[511px] self-center">
          <h1 className="druk-wide-bold text-white text-[68px] leading-[94px]">
            Turn Your Website Into Your Best Sales Person
          </h1>

          <div className="flex justify-end">
            <div className="w-[582px] mt-[30px]">
              <h3 className="rubik-300 leading-[33px] text-[22px] text-[#F7F7FF]">
                Triple your sales with a pixel-perfect website. <br />
                At SmartSite Studio, we don’t just design and write code, we
                build a revenue-driving machine for your business.
              </h3>
